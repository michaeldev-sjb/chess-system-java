...
public class ChessMatch {
    ...
    public boolean[][] possibleMoves(ChessPositon sourcePosition) {
    ...
    public ChessPiece performChessMove(ChessPositon sourcePosition, ChessPositon targetPosition) {
        ...
        if (testCheck(currentPlayer)) {
            ...
            throw new ChessException("You can't put ypurself in check");
        }
    ...
    private void validateTargetPosition(Position source, Position target) {
        if (!board.piece(source).possibleMoves(target)) {
            throw new ChessException("The chesen piece can't move to target position");
        }
    }
